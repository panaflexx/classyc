...
static int dap_send_dict(FILE *out, dict msg) {
    char *j = msg.json;
    if (!j) return -1;
    int ret = dap_send_message(out, j);
    return ret;
}
...
class DapServer {
    ...
    void send_event_simple(char *event_name) {
        ...
        dict ev = { "seq": 0, "type": "event", "event": "" };
        ev.seq = this->next_seq();
        ev.event = event_name;
    ...
    void handle_initialize(int req_seq) {
        ...
        dict resp = {
            "seq": 0, "type": "response",
            "request_seq": 0, "command": "initialize", "success": true
        };
    ...
    void handle_launch(int req_seq, dict args) {
        ...
        dict resp = {
            "seq": 0, "type": "response",
            "request_seq": 0, "command": "launch", "success": true
        };
        resp.request_seq = req_seq;
        dap_send_dict(this.write_fp, resp);
        this.state = 3;
    ...
    void handle_configuration_done(int req_seq) {
        dict resp = {
            "seq": 0, "type": "response",
            "request_seq": 0, "command": "configurationDone", "success": true
        };
        resp.request_seq = req_seq;
        dap_send_dict(this.write_fp, resp);
        this.state = 2;
    ...
    void handle_threads(int req_seq) {
        ...
        dict resp = {
            "seq": 0, "type": "response",
            "request_seq": 0, "command": "threads", "success": true
        };
        resp.request_seq = req_seq;
        resp.body = body;
        dap_send_dict(this.write_fp, resp);
    ...
    void handle_disconnect(int req_seq) {
        dict resp = {
            "seq": 0, "type": "response",
            "request_seq": 0, "command": "disconnect", "success": true
        };
        resp.request_seq = req_seq;
        dap_send_dict(this.write_fp, resp);
        this.state = 5;
    ...
    void handle_set_breakpoints(int req_seq) {
        ...
        dict resp = {
            "seq": 0, "type": "response",
            "request_seq": 0, "command": "setBreakpoints", "success": true
        };
        resp.request_seq = req_seq;
        resp.body = body;
        dap_send_dict(this.write_fp, resp);
    ...
    void handle_continue(int req_seq) {
        ...
        dict resp = {
            "seq": 0, "type": "response",
            "request_seq": 0, "command": "continue", "success": true
        };
        resp.request_seq = req_seq;
        resp.body = body;
        dap_send_dict(this.write_fp, resp);
    ...
    void handle_stack_trace(int req_seq) {
        ...
        dict resp = {
            "seq": 0, "type": "response",
            "request_seq": 0, "command": "stackTrace", "success": true
        };
        resp.request_seq = req_seq;
        resp.body = body;
        dap_send_dict(this.write_fp, resp);
    ...
    int dispatch_message(char *json_str) {
        ...
        if (strcmp(command, "initialize") == 0) {
            ...
            dict resp = {
                "seq": 0, "type": "response",
                "request_seq": 0, "command": "", "success": true
            };
            resp.request_seq = req_seq;
