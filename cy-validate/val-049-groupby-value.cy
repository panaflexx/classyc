/* val-049-groupby-value.cy — GroupBy returns Map<G, List<V>> by value.
 *
 * Phase B nested collections:
 *   auto g = nums.GroupBy(parity);   // Map<int, List<int>>; RAII, no owned/delete
 *
...
int main(void) {
    ...
    printf("-- 1. stack List.GroupBy --\n");
    {
        ...
        /* ~g frees map + nested List shells — no owned/delete */
    }
