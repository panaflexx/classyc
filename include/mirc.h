...
static const char mirc[]
  = "#define __mirc__ 1\n"
    ...
    "}\n"
    /* Darwin <math.h> inlines isfinite/isinf via these once __GNUC__ is set. */
    "static float __builtin_fabsf (float __x) {\n"
    "  union { unsigned u; float f; } __t;\n"
    "  __t.f = __x;\n"
    "  __t.u &= 0x7fffffffu;\n"
    "  return __t.f;\n"
    "}\n"
    "static double __builtin_fabs (double __x) {\n"
    "  union { unsigned long long u; double f; } __t;\n"
    "  __t.f = __x;\n"
    "  __t.u &= 0x7fffffffffffffffull;\n"
    "  return __t.f;\n"
    "}\n"
    "static long double __builtin_fabsl (long double __x) {\n"
